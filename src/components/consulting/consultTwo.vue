<template>
    <div class="consuleMain">
        ...
        <div class="item">
            <h3>解决方案</h3>
            <p style="color:#333"> 新学说咨询运用专业能力结合行业知识 、专家建议 、实地调研 、数据分析 ，解决客户痛点</p>
            <p>NSI Consultancy assists clients solve pressing problems and complex challenges. Through our unique skill set, we combine global industrial knowledge, professional expertise, field research, and data analysis. </p>
            <div class="mySteps">
              <ul>
                <li>
                ...
                <li>
                    ...
                    <div class="description" style="height:120px;">
                        ...
                        <p>专家访谈(Expert Interview)</p>
                        <p>实地走访(Field Rwswarch)</p>
                        <p>问卷调查(Questionnaire)</p>
                    </div>
                </li>
                <li>
